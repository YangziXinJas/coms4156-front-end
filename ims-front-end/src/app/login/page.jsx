    ...
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div className="flex w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-full xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form name="login-form" className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
            <div>
        ...
        <div className="flex-1 w-96">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form name="register-form" className="space-y-4 md:space-y-6" onSubmit={handleRegister}>
              <div>
                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
